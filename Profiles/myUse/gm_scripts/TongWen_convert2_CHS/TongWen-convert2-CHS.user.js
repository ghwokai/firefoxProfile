// ==UserScript==
// @name		TongWen convert2 CHS
// @namespace	a@b.c
// @author		mod by jasake
// @description	把繁体转换成简体，convert CHT 2 CHS
// @include		http:*
// @include		https:*
// @include		file://*
...
//根据此在线版修改
//https://raw.githubusercontent.com/skofkyo/userChromeJS/master/UserScriptLoader/bookmarklet_cn.js
...
//判断网页编码或网址
if (document.characterSet.toLowerCase() == 'big5' || /^(?:tw|big5)\.|\.(?:tw|big5)$/.test(location.host)) convert_simp();

//注册命令，手动转换
GM_registerMenuCommand("TongWen convert2 CHS", convert_simp);
