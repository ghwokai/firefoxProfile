...
// @version     2.3
// ==/UserScript==
// 2015-05-20.2.1    修改弹出位置，修改脚本生效位置，提供简易跳转
...
if(getJsonLength(queueList) > 0){
    ...
    popWindow("读取异常,可以跳转到<BR><center><a href=http://download.csdn.net/my/downloads><b><font color=Green>我的下载</font></b></a>查看</center>",0);
}
