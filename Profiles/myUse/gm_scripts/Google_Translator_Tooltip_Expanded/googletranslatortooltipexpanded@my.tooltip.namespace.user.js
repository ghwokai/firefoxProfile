...
function lookup(evt)
{
    ...
    else
    {
		...
		lang = sl + "|" + tl;
		//currentURL = "https://www.google.com/translate_t?text=" + encodeURIComponent(txtSel) + "&langpair=" + lang; // Basic address, for web page parsing
...
function addTextToSpeachLink(element, lang, text) {
	...
	speachLink.href = 'https://translate.google.com/?hl=zh-CN#auto/zh-CN/'+text.replace(/[«»'"]/g,' ');
	speachLink.target = '_blank';
	speachLink.innerHTML = '<img src="data:image/png;base64," height="16" width="16"/>';
