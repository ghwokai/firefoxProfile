...
location == "chrome://browser/content/browser.xul" && (function(){
    ...
    var buttons = [
		...
		{ id: "aup-toolbarbutton", bar: "vertical-toolbar",pos:6},// 翻墙扩展
        {id:"stylish-toolbar-button",bar:"vertical-toolbar",pos:7i},
		{ id: "stylish-toolbar-button", bar: "vertical-toolbar", pos: 9 },//stylish 扩展
	//	{ id: "loop-button-throttled", bar: "TabsToolbar_aidBar", pos: 3 },// hello功能
		{ id: "panic-button", bar: "vertical-toolbar", pos: 10 },// 清除缓存		
		{ id: "lpt_lastpass-compact-btn", bar: "vertical-toolbar" },// Lastpass 扩展
