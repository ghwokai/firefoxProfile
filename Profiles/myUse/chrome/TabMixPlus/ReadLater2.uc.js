...
// @homepageURL    https://github.com/defpt/userChromeJs/blob/master/ReadLater2.uc.js
// ==/UserScript==
...
readLater = {
  ...
  init: function(){
    ...
    this.ADDLABEL     = LOCALE?"Read this later!":"稍后再读";
    ...
    statusbarpanel.setAttribute("src","data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABEAAAARCAYAAAA7bUf6AAAAVUlEQVQ4jc2QQQ4AMAQEPd9XxSP01ojS0vbgsIlIjAEQUV4DfSFMJEw0a9336gWiAXbAA29NPOWoH5rorVHSJlmrI6Rs4p1TNrFbev3kOyR9zk36QAb7WC8H4qwjUAAAAABJRU5ErkJggg==");
    statusbarpanel.setAttribute("tooltiptext",this.TOOLTIP+"[0]");
    statusbarpanel.setAttribute("style","padding-top: 1px;");
