...
var GesCustomCommand = [
	//示例：
	{
		...
		Type:"",
		command:function(event){
			gPrefService.setBoolPref("browser.tabs.loadInBackground",!gPrefService.getBoolPref("browser.tabs.loadInBackground"));gPrefService.setBoolPref("browser.tabs.loadDivertedInBackground",!gPrefService.getBoolPref("browser.tabs.loadDivertedInBackground"));gPrefService.setBoolPref("browser.tabs.loadBookmarksInBackground",!gPrefService.getBoolPref("browser.tabs.loadBookmarksInBackground"))
		}
	}, {
		label: "打开音量控制器",
		command: function(event) {
